...
<button class="btn btn-primary btn-sm" legend="Tambah Item" data-toggle="modal" data-target="#t_pgjg">
  ...
  <div class="container">
    <center><h5 class="display-8">Kolom Pencarian Buku</h5></center>
    <table class="table">   
    ...
    <div class="form-check form-check-inline">
      ...
      <label class="form-check-label" for="inlineRadio2">by Kategori</label>
		...
		<div class="active-cyan-4 mb-4">
		  <input class="form-control" type="text" placeholder="Tulis judul/kategori buku yang ingin anda cari disini" name="cari" aria-label="Search">
		</div>
    </form>
    </table>
  </div>
